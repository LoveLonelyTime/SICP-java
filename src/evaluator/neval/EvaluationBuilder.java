...
public class EvaluationBuilder {
    ...
    private static Evaluation buildAMB(ListExpression exp) {
        return new AMBEvaluation(exp.getTail().stream().map(EvaluationBuilder::build).collect(Collectors.toList()));
    }
